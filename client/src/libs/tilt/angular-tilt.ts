...
export class VanillaTilt {
  ...
  isSettingTrue(setting: string | number | boolean) {
    return setting === "" || setting === true || setting === 1;
  }

  getElementListener(): any {
  ...
  onDeviceOrientation(event: { gamma: number | null; beta: number | null; }) {
  ...
  extendSettings(settings: VanillaTiltSettings) {
    ...
    for (var property in defaultSettings) {
      if (property in settings) {
        newSettings[property] = settings[property as keyof VanillaTiltSettings];
        ...
        newSettings[property] = defaultSettings[property as keyof VanillaTiltSettings];
      }
    }
  ...
  static init(elements: any[] | NodeList, settings: VanillaTiltSettings | undefined) {
